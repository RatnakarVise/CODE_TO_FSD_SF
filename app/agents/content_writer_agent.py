...
SECTION_BUNDLES = [
    ...
    (["UI Requirement"], ["selection_scr"]),
    (["Functional Scope"], ['pgm_name', 'type', 'explanation']),
    (["Functional Solution Approach"], ['pgm_name', 'type', 'explanation']),
    (["Interfaces & Integration","Error Handling & Notifications", "Assumptions & Dependencies", "Authorization & Security"], ['selection_scr', 'declarations', 'explanation']),
    (["Test Scenario"], ['selection_scr', 'declarations', 'explanation']),
...
class ContentWriterAgent:
    ...
    def generate_sections(self, section_names, section_bibles, payload) -> Dict[str, str]:
        ...
        batched_prompt = "You are an expert SAP ABAP functional specification writer.\n"
